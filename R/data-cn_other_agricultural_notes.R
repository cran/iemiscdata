#' Notes for Table 2-2c: Runoff curve numbers for other agricultural lands
#'
#' A table containing the notes for the curve numbers for other agricultural
#' areas.
#'
#'
#'
#' @format A data.table data frame with 11 rows and 2 variables:
#' \describe{
...
#'
#'
"cn_other_agricultural_notes"
#> [1] "cn_other_agricultural_notes"
