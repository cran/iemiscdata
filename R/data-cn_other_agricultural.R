...
#'
#' A table containing curve numbers for other agricultural areas.
#'
#'
#'
#' @format A data.table data frame with 19 rows and 7 variables:
#' \describe{
#' item{Cover type}{Type of agricultural ground cover}
#' item{Hydrologic condition *3}{Hydrologic condition}
#' item{Curve numbers for hydrologic soil group A}{Curve numbers for soil group A}
#' item{Notes}{Any notes for soil group A}
