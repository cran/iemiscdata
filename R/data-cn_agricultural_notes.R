#' Notes for Table 2-2b: Runoff curve numbers for cultivated agricultural lands
#'
#' A table containing the notes for the curve numbers for cultivated,
#' agricultural areas.
#'
#'
#'
...
#'
#'
"cn_agricultural_notes"
#> [1] "cn_agricultural_notes"
