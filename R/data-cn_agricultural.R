...
#'
#' A table containing curve numbers for cultivated, agricultural areas.
#'
#'
#'
#' @format A data.table data frame with 36 rows and 7 variables:
#' \describe{
#' \item{Cover type}{Type of agricultural ground cover}
#' \item{Treatment *2}{Agricultural land treatment}
