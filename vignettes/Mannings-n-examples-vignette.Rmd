...
The examples make more sense if you have familiarized yourself with the nchannel, npartfull, and nmetalpipe tables. There are instructions to view the tables, as a .pdf, in the [View-PDF-table-vignette](https://cran.r-project.org/web/packages/iemiscdata/vignettes/View-PDF-table-vignette.html).
